<cfif structKeyExists(form, "submit")>
    ...
    <h3 style="text-align:center;color:green;">Application submitted successfully!</h3>
</cfif>
<cfoutput>
<!DOCTYPE html>
<html>
            ...
            <div class="col-8 checkout-col-12">
                <form id="empForm" method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="container">
                        ...
                        <div class="checkout-item">
                            <label>Portfolio Website<span class="text-danger required">*</span></label>
                            <input type="text" name="portfolio" id="portfolio" value="http://">
                        </div>
                        <div class="checkout-item">
                            <label>Attach a copy of Your Resume<span class="text-danger required">*</span></label>
                            <input type="file" name="resumePath" id="resumePath"><br>
                            <p>Word or PDF Documents Only</p>
                        </div>
                        <div class="checkout-item">
                            <label>Salary Requirements<span class="text-danger required">*</span></label>
                            <div class="dollar">
